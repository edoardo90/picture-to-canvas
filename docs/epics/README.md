...
| E-2 | Paper setup | Inserisce dimensioni foglio reale (larghezza × altezza, unità) | E-1 | backlog |
| E-3 | Point placement | Tocca un punto sulla foto → ottiene coordinate reali sul foglio | E-1, E-2 | backlog |
| E-4 | Coordinate display | Mostra le coordinate in modo leggibile (numeri grandi, contrasto alto) | E-3 | backlog |
| E-5 | Multiple points | Piazza e gestisce più punti, ognuno con un ID | E-3 | backlog |
